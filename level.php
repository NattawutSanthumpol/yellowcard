...
<body>
	...
	<div class="container"><br>
		<div class="row justify-content-md-center">
			<div class="col-auto">
				<form action="addwrong.php" method="POST" enctype="multipart/form-data" name="form1">
				...
				<table border="1" class="table table-hover table-responsive">
					<thead class="thead-dark">
						<tr align="center">
							<th scope="col">รหัสสิทธิ์</th>
							<th scope="col">รายการสิทธิ์</th>
						</tr>
					</thead>
					<tbody>
						<?php while ($objResult = mysqli_fetch_array($objQuery,MYSQLI_ASSOC)) { ?>
							<tr>
								<th scope="row" class="text-center"><?= $objResult["lvl_id"] ?></th>
