...
<body>
	...
	<div class="container"><br>
		<div class="row justify-content-md-center">
			<div class="col-lx-7">
				<form action="add_wrong.php" method="POST" enctype="multipart/form-data" name="form1">
				...
				<table border="1" class="table table-hover table-responsive">
					<thead class="thead-dark">
						<tr align="center">
							<th scope="col">#</th>
							<th scope="col">รายการความผิด</th>
							<th scope="col">คะแนนความผิด</th>
					...
					<tbody>
						<?php while ($objResult = mysqli_fetch_array($objQuery,MYSQLI_ASSOC)) { ?>
							<tr>
								<td scope="row" class="text-center"><?= $objResult["wr_id"] ?></td>
								<td><?= $objResult["wr_name"] ?></td>
								<td scope="row" class="text-center"><?= $objResult["wr_score"] ?></td>
								<td align="center">
									<a href="edit_wrong.php?id=<?= $objResult['wr_id'] ?>" class="btn btn-warning btn-sm click">แก้ไขข้อมูล</a>
								</td>
							</tr> 
						<?php } ?> 
					</tbody>
